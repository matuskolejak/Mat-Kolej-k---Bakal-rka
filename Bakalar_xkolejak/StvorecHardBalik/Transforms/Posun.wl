...
NormalizeVertices[vertices_] := 
    Module[{processedVertices},
        ...
        (* Vrac\[IAcute]ame presn\[EAcute] hodnoty bez zaokr\[UAcute]h\:013eovania *)
    ...
    Module[{dx, dy, valid = False, newVertices, 
        ...
        While[!valid,
            ...
            valid = 
                ...
                (* Zabr\[AAcute]nenie prieniku \[SHacek]tvorcov *)
                Min[
                    Table[
...
CreateVisualization[originalVertices_, finalVertices_, translationVector_] := 
    Module[{allVertices, xMin, xMax, yMin, yMax, rangeBuffer, xRange, yRange, 
        ...
        Graphics[{
            ...
            (* Posunut\[YAcute] \[SHacek]tvorec - \[CHacek]erven\[YAcute] *)
            Red, Thick, Opacity[0.7],
            Line[Append[finalVertices, First[finalVertices]]],
            
            (* Vektor posunu - zelena sipka bola odstranena *)
...
StvorecPosun[inputVertices_] := 
    Module[{normalizedVertices, translationParams, outputVertices, dx, dy, invDx, invDy},
        ...
        If[Length[inputVertices] === 4 && validSquareQ @@ inputVertices,
        ...
        Print["Vrcholy \[SHacek]tvorca po posune:"];
        ...
        Print["\[Bullet] \[CapitalCHacek]erven\[EAcute] body a \[CHacek]iary: Posunut\[YAcute] \[SHacek]tvorec"];
...
StvorecPosun::insufficientVertices = "Nedostato\[CHacek]n\[YAcute] po\[CHacek]et vrcholov. S\[UAcute] potrebn\[EAcute] aspo\[NHacek] 4 vrcholy.";
