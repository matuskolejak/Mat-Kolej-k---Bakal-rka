...
CreateVisualization[originalVertices_, finalVertices_, k_, smer_] := 
    Module[{allVertices, xMin, xMax, yMin, yMax, rangeBuffer, xRange, yRange, 
        ...
        Graphics[{
            ...
            (* Skosen\[YAcute] \[SHacek]tvorec - \[CHacek]erven\[YAcute] *)
...
StvorecSkosenie[inputVertices_] := 
    Module[{normalizedVertices, shearParams, outputVertices, kx, ky, smer, popis, 
        ...
        Print["\nVykonajte skosenie \[SHacek]tvorcav 2D priestore" <> smer <> " s koeficientom k = ", 
        ...
        Print["Vrcholy \[SHacek]tvorca po skosen\[IAcute]:"];
        ...
        Print["\[Bullet] \[CapitalCHacek]erven\[EAcute] body a \[CHacek]iary: Skosen\[YAcute] \[SHacek]tvorec"];
        ...
        (* \[CapitalSHacek]peci\[AAcute]lne pr\[IAcute]pady pre \[SHacek]tvorec *)
        Print[Style["\n\[CapitalSHacek]PECI\[CapitalAAcute]LNE PR\[CapitalIAcute]PADY PRE \[CapitalSHacek]TVOREC:", Bold, 14]];
        Print["\[Bullet] Pre k = 0 je skosenie identickou transform\[AAcute]ciou (\[SHacek]tvorec sa nemen\[IAcute])"];
        Print["\[Bullet] Pre ve\:013ek\[EAcute] hodnoty |k| sa \[SHacek]tvorec v\[YAcute]razne skos\[IAcute] a m\[OHat]\[ZHacek]e pripom\[IAcute]na\[THacek] kosod\:013a\[ZHacek]nik alebo kosod\[IAcute][ZHacek]nik"];
        Print["\[Bullet] Pri skosen\[IAcute] \[SHacek]tvorca sa zachov\[AAcute]va jeho obsah, ale menia sa vn\[UAcute]torn\[EAcute] uhly"];
        Print["\[Bullet] Proti\:013eahl\[EAcute] strany \[SHacek]tvorca zost\[AAcute]vaj\[UAcute] rovnobe\[ZHacek]n\[EAcute] aj po skosen\[IAcute]"];
        Print["\[Bullet] Skosenie \[SHacek]tvorca v oboch smeroch (x aj y) s rovnak\[YAcute]m koeficientom vedie k jeho deform\[AAcute]cii na rovnobe\[ZHacek]n\[IAcute]k"];
...
StvorecSkosenie::insufficientVertices = "Nedostato\[CHacek]n\[YAcute] po\[CHacek]et vrcholov. S\[UAcute] potrebn\[EAcute] aspo\[NHacek] 4 vrcholy pre \[SHacek]tvorec.";
