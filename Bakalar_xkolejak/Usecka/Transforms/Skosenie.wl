...
BeginPackage["UseckaHardBalik`Transforms`Skosenie`", {"UseckaHardBalik`"}];


UseckaSkosenie::usage = 
    "UseckaSkosenie[vertices_] zobraz\[IAcute] interakt\[IAcute]vny tutori\[AAcute]l pre skosenie \[UAcute]se\[CHacek]ky a vr\[AAcute]ti nov\[EAcute] koncov\[EAcute] body.";


SkosenieParams::usage = "SkosenieParams je globalny parameter skosenia {kx, ky}, ktory sa pouziva v UseckaSkosenie funkcii.";


UseckaSkosenieNoDisplayWithParams::usage = 
    "UseckaSkosenieNoDisplayWithParams[vertices_] vrati parametry skosenia a nove vrcholy bez zobrazovania.";
...
NormalizeVertices[vertices_] := 
    Module[{processedVertices},
                ...
                If[Length[DeleteDuplicates[Length /@ vertices]] > 1,
                    ...
                    Block[{cleanedVertices = Select[vertices, VectorQ]},
                        If[Length[cleanedVertices] >= 2,
                            cleanedVertices[[1;;2]],
                            Message[UseckaSkosenie::invalidInput]; 
                            Abort[]
                        ]
                    ],
        ...
        If[Length[processedVertices] < 2,
            Message[UseckaSkosenie::insufficientVertices];
            Abort[]
        ];
...
UseckaSkosenie[inputVertices_] := 
    Module[{normalizedVertices, shearParams, outputVertices, kx, ky, smer, popis, 
        ...
        normalizedVertices = If[MatrixQ[inputVertices] && Length[inputVertices] == 2 && 
        ...
        Print[Style[
            "GEOMETRICK\[CapitalEAcute] TRANSFORM\[CapitalAAcute]CIE \[CapitalUAcute]SE\[CapitalCHacek]KY - SKOSENIE", 
            Bold, 16]];
        Print[Style["========================================", Bold]];
        ...
        If[smer == "v smere os\[IAcute] x a y",
            Print["\nVykonajte skosenie \[UAcute]se\[CHacek]ky v 2D priestore v smere osi x s koeficientom k = ", 
                Style[FormatExactValue[kx], Red], " a v smere osi y s koeficientom k = ", 
                Style[FormatExactValue[ky], Red], "."];
        ,
            Print["\nVykonajte skosenie \[UAcute]se\[CHacek]ky v 2D priestore " <> smer <> " s koeficientom k = ", 
        ...
        Print[Style["\nV\[CapitalYAcute]PO\[CapitalCHacek]ET SKOSENIA JEDNOTLIV\[CapitalYAcute]CH BODOV:", Bold, 14]];
        ...
        Print[Style["Skosen\[AAcute] \[UAcute]se\[CHacek]ka A'B':", Red, Bold]];
        ...
        Print[Style["\[Bullet] \[CapitalCHacek]erven\[EAcute]", Red], " body a \[CHacek]iary: Skosen\[AAcute] \[UAcute]se\[CHacek]ka"];
        Print[Style["\[Bullet] Zelen\[EAcute]", darkGreen], " preru\[SHacek]ovan\[EAcute] \[CHacek]iary: Dr\[AAcute]ha pohybu bodov pri skosen\[IAcute]"];
        ...
        Print["\[Bullet] Skosenie men\[IAcute] uhly a sklon \[UAcute]se\[CHacek]iek, ale zachov\[AAcute]va rovnobe\[ZHacek]nos\[THacek] s osami"];
        ...
        Print["\[Bullet] Pre ve\:013ek\[EAcute] hodnoty |k| sa \[UAcute]se\[CHacek]ka v\[YAcute]razne skos\[IAcute] a m\[OHat]\[ZHacek]e by\[THacek] \[THacek]a\[ZHacek]\[SHacek]ie rozpoznate\:013en\[AAcute]"];
        Print["\[Bullet] Pre k = 1 sa \[UAcute]se\[CHacek]ka skos\[IAcute] do 45-stup\[NHacek]ov\[EAcute]ho uhla (ak le\[ZHacek]\[IAcute] na osi)"];
        Print["\[Bullet] Pre k = -1 sa \[UAcute]se\[CHacek]ka skos\[IAcute] do -45-stup\[NHacek]ov\[EAcute]ho uhla (ak le\[ZHacek]\[IAcute] na osi)"];
...
UseckaSkosenie::invalidInput = "Neplatn\[YAcute] vstup. O\[CHacek]ak\[AAcute]va sa matica alebo zoznam s\[UAcute]radn\[IAcute]c \[UAcute]se\[CHacek]ky.";
UseckaSkosenie::insufficientVertices = "Nedostato\[CHacek]n\[YAcute] po\[CHacek]et bodov. S\[UAcute] potrebn\[EAcute] aspo\[NHacek] 2 body pre \[UAcute]se\[CHacek]ku.";
