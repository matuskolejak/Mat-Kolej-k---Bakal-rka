...
BeginPackage["UseckaHardBalik`Transforms`Rotacia`", {"UseckaHardBalik`"}];


UseckaRotacia::usage = 
    "UseckaRotacia[vertices_] zobraz\[IAcute] interakt\[IAcute]vny tutori\[AAcute]l pre rot\[AAcute]ciu \[UAcute]se\[CHacek]ky okolo po\[CHacek]iatku a vr\[AAcute]ti nov\[EAcute] body.";
...
UseckaRotacia[inputVertices_] := 
    Module[{normalizedVertices, angle, popis, outputVertices, cosA, sinA, invAngle, cosInvA, sinInvA,
        ...
        normalizedVertices = If[Length[inputVertices] >= 2, 
                                inputVertices[[1;;2]], 
                                Message[UseckaRotacia::insufficientVertices]; Abort[]];
        ...
        Print[Style[
            "GEOMETRICK\[CapitalEAcute] TRANSFORM\[CapitalAAcute]CIE \[CapitalUAcute]SE\[CapitalCHacek]KY - ROT\[CapitalAAcute]CIA", 
            Bold, 16]];
        Print[Style["========================================", Bold]];
        ...
        Print["\nVykonajte rot\[AAcute]ciu \[UAcute]se\[CHacek]ky v 2D priestore okolo po\[CHacek]iatku s\[UAcute]radnicovej s\[UAcute]stavy [0,0] o uhol \[Alpha] = ", 
        ...
        Print[Style["\nV\[CapitalYAcute]PO\[CapitalCHacek]ET ROT\[CapitalAAcute]CIE JEDNOTLIV\[CapitalYAcute]CH BODOV:", Bold, 14]];
        ...
        Print[Style["Rotovan\[AAcute] \[UAcute]se\[CHacek]ka A'B':", Red, Bold]];
        ...
        Print[Style["\[Bullet] \[CapitalCHacek]erven\[EAcute]", Red], " body a \[CHacek]iary: Rotovan\[AAcute] \[UAcute]se\[CHacek]ka"];
        ...
        Print["\[Bullet] Rot\[AAcute]cia nemen\[IAcute] d\:013a\[ZHacek]ku \[UAcute]se\[CHacek]ky - je to izometria"];
...
NormalizeVertices[vertices_] := 
    Module[{processedVertices},
                ...
                If[Length[DeleteDuplicates[Length /@ vertices]] > 1,
                    ...
                    Block[{cleanedVertices = Select[vertices, VectorQ]},
                        If[Length[cleanedVertices] >= 2,
                            cleanedVertices[[1;;2]],
                            Message[UseckaRotacia::invalidInput]; 
                            Abort[]
                        ]
                    ],
        ...
        If[Length[processedVertices] < 2,
            Message[UseckaRotacia::insufficientVertices];
            Abort[]
        ];
...
UseckaRotacia::invalidInput = "Neplatn\[YAcute] vstup. O\[CHacek]ak\[AAcute]va sa matica alebo zoznam s\[UAcute]radn\[IAcute]c \[UAcute]se\[CHacek]ky.";
UseckaRotacia::insufficientVertices = "Nedostato\[CHacek]n\[YAcute] po\[CHacek]et bodov. S\[UAcute] potrebn\[EAcute] aspo\[NHacek] 2 body.";
