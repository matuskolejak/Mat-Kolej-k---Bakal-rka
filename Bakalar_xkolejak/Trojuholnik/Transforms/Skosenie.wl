...
SkosenieParams::usage = "SkosenieParams je globalny parameter skosenia {kx, ky}, ktory sa pouziva v TrojuholnikSkosenie funkcii.";


TrojuholnikSkosenieNoDisplayWithParams::usage = 
    "TrojuholnikSkosenieNoDisplayWithParams[vertices_] vrati parametry skosenia a nove vrcholy bez zobrazovania.";
...
TrojuholnikSkosenie[inputVertices_] := 
    Module[{normalizedVertices, shearParams, outputVertices, kx, ky, smer, popis, 
        ...
        normalizedVertices = If[MatrixQ[inputVertices] && Length[inputVertices] == 3 && 
        ...
        If[smer == "v smere os\[IAcute] x a y",
            Print["\nVykonajte skosenie trojuholn\[IAcute]ka v 2D priestore v smere osi x s koeficientom k = ", 
        ...
        Print[Style["Skosen\[YAcute] trojuholn\[IAcute]k A'B'C':", Red, Bold]];
        ...
        Print[Style["\[Bullet] \[CapitalCHacek]erven\[EAcute]", Red], " body a \[CHacek]iary: Skosen\[YAcute] trojuholn\[IAcute]k"];
