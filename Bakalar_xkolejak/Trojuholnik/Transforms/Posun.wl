...
BeginPackage["TrojuholnikHardBalik`Transforms`Posun`", {"TrojuholnikHardBalik`"}];


TrojuholnikPosunVector::usage = "TrojuholnikPosunVector je globalny vektor posunu [dx, dy], ktory sa pouziva v TrojuholnikPosun funkcii.";

TrojuholnikPosun::usage = 
    "TrojuholnikPosun[vertices_] zobraz\[IAcute] interakt\[IAcute]vny tutori\[AAcute]l pre posun trojuholn\[IAcute]ka a vr\[AAcute]ti nov\[EAcute] vrcholy.";

Begin["`Private`"];

TrojuholnikPosunVector = {0, 0};
...
NormalizeVertices[vertices_] := 
    Module[{processedVertices},
                ...
                If[Length[DeleteDuplicates[Length /@ vertices]] > 1,
                    ...
                    Block[{cleanedVertices = Select[vertices, VectorQ]},
                        If[Length[cleanedVertices] >= 3,
                            cleanedVertices[[1;;3]],
                            Message[TrojuholnikPosun::invalidInput]; 
                            Abort[]
                        ]
                    ],
        ...
        If[Length[processedVertices] < 3,
            Message[TrojuholnikPosun::insufficientVertices];
            Abort[]
        ];
...
TrojuholnikPosun[inputVertices_] := 
    Module[{normalizedVertices, outputVertices, dx, dy, invDx, invDy,
        ...
        If[TrojuholnikPosunVector =!= {0, 0},
            
            {dx, dy} = TrojuholnikPosunVector;
        ...
        Print[Style[
            "GEOMETRICK\[CapitalEAcute] TRANSFORM\[CapitalAAcute]CIE TROJUHOLN\[CapitalIAcute]KA - POSUN", 
            Bold, 16]];
        Print[Style["========================================", Bold]];
        ...
        Print["\nVykonajte posun trojuholn\[IAcute]ka v 2D priestore pomocou vektora posunu: \[CapitalDelta] = [", 
        ...
        Print[Style["\nV\[CapitalYAcute]PO\[CapitalCHacek]ET POSUNU JEDNOTLIV\[CapitalYAcute]CH VRCHOLOV:", Bold, 14]];
        ...
        Print[Style["Posunut\[YAcute] trojuholn\[IAcute]k A'B'C':", Red, Bold]];
        ...
        Print[Style["\[Bullet] \[CapitalCHacek]erven\[EAcute]", Red], " body a \[CHacek]iary: Posunut\[YAcute] trojuholn\[IAcute]k"];
        Print[Style["\[Bullet] Zelen\[EAcute]", darkGreen], " preru\[SHacek]ovan\[EAcute] \[CHacek]iary: Posun jednotliv\[YAcute]ch vrcholov"];
		...
		Print["\[Bullet] Posun zachov\[AAcute]va obsah a obvod trojuholn\[IAcute]ka"];
...
TrojuholnikPosun::invalidInput = "Neplatn\[YAcute] vstup. O\[CHacek]ak\[AAcute]va sa matica alebo zoznam s\[UAcute]radn\[IAcute]c trojuholn\[IAcute]ka.";
TrojuholnikPosun::insufficientVertices = "Nedostato\[CHacek]n\[YAcute] po\[CHacek]et vrcholov. S\[UAcute] potrebn\[EAcute] aspo\[NHacek] 3 vrcholy.";
