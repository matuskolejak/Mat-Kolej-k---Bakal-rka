...
TrojuholnikRotacia[inputVertices_] := 
    Module[{normalizedVertices, angle, popis, outputVertices, cosA, sinA, invAngle, cosInvA, sinInvA,
        ...
        normalizedVertices = If[Length[inputVertices] >= 3, 
                                inputVertices[[1;;3]], 
                                Message[TrojuholnikRotacia::insufficientVertices]; Abort[]];
        ...
        Print[Style["Rotovan\[YAcute] trojuholn\[IAcute]k A'B'C':", Red, Bold]];
        ...
        Print[Style["\[Bullet] \[CapitalCHacek]erven\[EAcute]", Red], " body a \[CHacek]iary: Rotovan\[YAcute] trojuholn\[IAcute]k"];
