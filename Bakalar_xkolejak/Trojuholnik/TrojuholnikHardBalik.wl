        ...
        "Symetria", 
            ...
            Switch[params,
                ...
                If[ListQ[params] && Length[params] == 3,
                    ...
                    If[ValueQ[TrojuholnikHardBalik`Transforms`Symetria`SymetriaMatrix],
                        
                        TrojuholnikHardBalik`Transforms`Symetria`SymetriaMatrix,
...
ApplyTransformationMatrixToTriangle[matrix_, triangle_] :=
    Map[ApplyTransformationMatrix[matrix, #] &, triangle];
...
VerifyCompositeTransformation[originalTriangle_, compositeMatrix_, finalTriangle_, compositeSteps_:{}] :=
    Module[{calculatedTriangle, i, exactCompositeMatrix, exactOriginalTriangle, exactFinalTriangle},
        
        exactCompositeMatrix = compositeMatrix;
        
        
        exactOriginalTriangle = originalTriangle;
        exactFinalTriangle = finalTriangle;
        
        Print[Style["\nAPLIK\[CapitalAAcute]CIA S\[CapitalUAcute]HRNNEJ MATICE NA P\[CapitalOHat]VODN\[CapitalYAcute] TROJUHOLN\[CapitalIAcute]K:", Bold, 16]];
        ...
        Print[Style["\nP\[OHat]vodn\[YAcute] trojuholn\[IAcute]k ABC:", Bold, Blue, 14]];
        Print[TableForm[
            exactOriginalTriangle,
            TableHeadings -> {{"A", "B", "C"}, {"x", "y"}},
            TableAlignments -> Center
        ]];
        
        
        calculatedTriangle = Table[
            Module[{vertex = exactOriginalTriangle[[i]], homogeneousVertex, resultVector},
            ...
            {i, Length[exactOriginalTriangle]}
        ];
        
        
        Print[Style["\nPostup pri aplikovan\[IAcute] s\[UAcute]hrnnej transforma\[CHacek]nej matice na trojuholn\[IAcute]k:", Bold, 14]];
        ...
        For[i = 1, i <= Length[exactOriginalTriangle], i++,
            Module[{vertex = exactOriginalTriangle[[i]], homogeneousVertex, resultVector, label},
                homogeneousVertex = Append[vertex, 1];
                resultVector = exactCompositeMatrix . homogeneousVertex;
                
                
                label = Switch[i, 1, "A", 2, "B", 3, "C"];
                ...
                Print["O\[CHacek]ak\[AAcute]van\[YAcute] v\[YAcute]sledok (", label, "'): ", 
                     Style[exactFinalTriangle[[i]], RGBColor[0.9, 0.1, 0.1]]];
                
                
                Module[{difference, tolerance = 10^-4},
                    difference = Norm[Take[resultVector, 2] - exactFinalTriangle[[i]]];
        ...
        Print[Style["\nV\[CapitalYAcute]SLEDN\[CapitalYAcute] TRANSFORMOVAN\[CapitalYAcute] TROJUHOLN\[CapitalIAcute]K A'B'C':", Bold, 16, RGBColor[0, 0.6, 0]]];
        Print[TableForm[
            calculatedTriangle,
            TableHeadings -> {{"A'", "B'", "C'"}, {"x", "y"}},
            TableAlignments -> Center
        ...
        Print[Style["\nO\[CHacek]ak\[AAcute]van\[YAcute] v\[YAcute]sledn\[YAcute] trojuholn\[IAcute]k:", Bold, 14, RGBColor[0.9, 0.1, 0.1]]];
        Print[TableForm[
            exactFinalTriangle,
            TableHeadings -> {{"A'", "B'", "C'"}, {"x", "y"}},
            TableAlignments -> Center
        ...
        Module[{difference, tolerance = 10^-4},
            difference = Norm[Flatten[calculatedTriangle] - Flatten[exactFinalTriangle]];
...
FormatTransformationDetailedDescription[transformType_, params_] := 
    Switch[transformType,
        "Posun", 
            Row[{"Vykonajte posun trojuholn\[IAcute]ka v 2D priestore pomocou vektora posunu ", 
                 Style[ToString[InputForm[params]], Blue, Bold]}],
                 
        "Rot\[AAcute]cia", 
            Row[{"Vykonajte rot\[AAcute]ciu trojuholn\[IAcute]ka v 2D priestore okolo po\[CHacek]iatku s\[UAcute]radnicovej s\[UAcute]stavy [0,0] o uhol ", 
        ...
        "Skosenie",
            With[{
                ...
                If[kx != 0 && ky == 0,
                    Row[{"Vykonajte skosenie trojuholn\[IAcute]ka v 2D priestore v smere osi x s koeficientom ", 
                         Style[ToString[TraditionalForm[kx]], Blue, Bold]}],
                    If[kx == 0 && ky != 0,
                        Row[{"Vykonajte skosenie trojuholn\[IAcute]ka v 2D priestore v smere osi y s koeficientom ", 
        ...
        "Symetria",
            Switch[params,
                "os x", "Vykonajte symetriu trojuholn\[IAcute]ka v 2D priestore pod\:013ea osi x (priamky y = 0)",
                "os y", "Vykonajte symetriu trojuholn\[IAcute]ka v 2D priestore pod\:013ea osi y (priamky x = 0)",
                "priamka y=x", "Vykonajte symetriu trojuholn\[IAcute]ka v 2D priestore pod\:013ea priamky y = x",
                "priamka y=-x", "Vykonajte symetriu trojuholn\[IAcute]ka v 2D priestore pod\:013ea priamky y = -x",
                "complex", 
                    "Vykonajte symetriu trojuholn\[IAcute]ka v 2D priestore pod\:013ea v\[SHacek]eobecnej priamky",
                _,
                If[ListQ[params] && Length[params] == 3,
                    Module[{a, b, c, standardForm},
                        ...
                        Row[{
                            "Vykonajte symetriu trojuholn\[IAcute]ka v 2D priestore pod\:013ea priamky ",
                            Style[standardForm, Blue, Bold]
                        }]
                    ],
                    
                    "Vykonajte symetriu trojuholn\[IAcute]ka v 2D priestore pod\:013ea danej priamky"
                ]
            ],
            
        _,
            "Vykonajte " <> transformType <> " trojuholn\[IAcute]ka"
    ];
...
CreateTriangleVisualization[pociatocny_, druhy_, treti_, finalny_, prva_, druha_, tretia_] := 
    Module[{
            ...
            totalVertices = 3 * (1 + 1 + If[showSecond, 1, 0] + If[showThird, 1, 0]);
            ...
            Do[
                With[{
                        label = FromCharacterCode[64 + (i - 3)] <> "'",
                        color = brightGreen,
                        pos = labelPositions[[i]]
                    },
                    AppendTo[vertexLabels, 
            ...
            If[showThird,
                Do[
                    With[{
                            label = FromCharacterCode[64 + (i - 9)] <> "'''",
                            color = brightRed,
                            pos = labelPositions[[i]]
                        },
                        AppendTo[vertexLabels, 
            ...
            Graphics[graphicsElements,
              ...
              PlotLabel -> Style["Postupn\[AAcute] aplik\[AAcute]cia " <> ToString[numTransformations] <> 
                           Switch[numTransformations, 
                               ...
                               _, " transform\[AAcute]ci\[IAcute]"] <> " trojuholn\[IAcute]ka", Bold, 16],
...
DisplayComplexAssignment[pociatocny_, prva_, druha_, tretia_] := 
    Module[{},
        ...
        If[prva == "Posun",
            ...
            Module[{posunVector = TrojuholnikHardBalik`Transforms`Posun`TrojuholnikPosunVector},
        ...
        Print[Style["M\[AAcute]te trojuholn\[IAcute]k ABC s vrcholmi:", Bold, 14]];
        Print[MatrixForm[Map[Style[#, Blue] &, pociatocny, {2}]]];
        
        
        Print[Style["\nPOSTUP:", Bold, 16]];
        Print["1. Aplikujte prv\[UAcute] transform\[AAcute]ciu na p\[OHat]vodn\[YAcute] trojuholn\[IAcute]k ABC, \[CHacek]\[IAcute]m z\[IAcute]skate trojuholn\[IAcute]k A'B'C'"];
        Print["2. Aplikujte druh\[UAcute] transform\[AAcute]ciu na trojuholn\[IAcute]k A'B'C', \[CHacek]\[IAcute]m z\[IAcute]skate trojuholn\[IAcute]k A''B''C''"];
        Print["3. Aplikujte tretiu transform\[AAcute]ciu na trojuholn\[IAcute]k A''B''C'', \[CHacek]\[IAcute]m z\[IAcute]skate fin\[AAcute]lny trojuholn\[IAcute]k A'''B'''C'''"];
    ...
    Module[{sx, sy, finalVertices, normalizedVertices, detectedScaling = None, detectedFinalVertices = None},
        ...
        If[detectedScaling =!= None,
            ...
            If[TrojuholnikHardBalik`Transforms`ZvacsenieZmensenie`ZvacsenieParams =!= {0, 0},
                ...
                Module[{result},
                    result = TrojuholnikHardBalik`Transforms`ZvacsenieZmensenie`GenerateScalingParameters[];
                    sx = result[[1]];
                    sy = result[[2]];
                ]
            ];
...
TrojuholnikRotaciaNoDisplayWithParams[vertices_] := 
    Module[{angle, result},
        
        If[TrojuholnikHardBalik`Transforms`Rotacia`RotaciaUhol != 0,
            angle = TrojuholnikHardBalik`Transforms`Rotacia`RotaciaUhol,
            angle = RandomChoice[{30, 45, 60, 90, 120, 135, 180, 270}];
            
            TrojuholnikHardBalik`Transforms`Rotacia`RotaciaUhol = angle;
        ];
...
TrojuholnikSkosenieNoDisplayWithParams[vertices_] := 
    Module[{kx, ky, result},
        
        If[TrojuholnikHardBalik`Transforms`Skosenie`SkosenieParams =!= {0, 0},
            {kx, ky} = TrojuholnikHardBalik`Transforms`Skosenie`SkosenieParams;
            
            TrojuholnikHardBalik`Transforms`Skosenie`SkosenieParams = {0, 0},
        ...
        TrojuholnikHardBalik`Transforms`Skosenie`SkosenieParams = {kx, ky};
...
TrojuholnikSymetriaNoDisplayWithParams[vertices_] := 
    Module[{axis, result, a, b, c, lineParams, specialAxes, randomAxis},
        
        specialAxes = {"os x", "os y", "priamka y=x", "priamka y=-x"};
        
        
        If[TrueMemberQ[{Null, "complex"}, TrojuholnikHardBalik`Transforms`SymetriaOs] || 
           !MemberQ[Join[specialAxes, _List], TrojuholnikHardBalik`Transforms`SymetriaOs],
           ...
           axis = TrojuholnikHardBalik`Transforms`SymetriaOs;
        ];
        ...
        TrojuholnikHardBalik`Transforms`Symetria`SymetriaOs = axis;
...
TrojuholnikTrojitaTransformacia[] := Module[{
    ...
    TrojuholnikHardBalik`Transforms`Symetria`SymetriaOs = Null;
    TrojuholnikHardBalik`Transforms`Rotacia`RotaciaUhol = 0;
    TrojuholnikHardBalik`Transforms`Posun`TrojuholnikPosunVector = {0, 0};
    TrojuholnikHardBalik`Transforms`ZvacsenieZmensenie`ZvacsenieParams = {0, 0};
    TrojuholnikHardBalik`Transforms`Skosenie`SkosenieParams = {0, 0};
    ...
    transformovane = {pociatocnyTrojuholnik};
    ...
    If[numTransformations >= 1, 
        ...
        druhyTrojuholnik = Switch[prvaTransformacia,
            "Posun", Module[{result, dx, dy, translationParams}, 
                ...
                translationParams = GetTranslationParametersNoDisplay[pociatocnyTrojuholnik];
            ...
            "Rot\[AAcute]cia", Module[{result, angle},
                ...
                If[rotaciaUhol1 != 0,
                    TrojuholnikHardBalik`Transforms`Rotacia`RotaciaUhol = rotaciaUhol1;
                ];
                
                
                {angle, result} = TrojuholnikRotaciaNoDisplayWithParams[pociatocnyTrojuholnik];
            ...
            "Zv\[ADoubleDot]\[CHacek]\[SHacek]enie/Zmen\[SHacek]enie", Module[{result, params},
                ...
                {params, result} = TrojuholnikZvacsenieZmensenieNoDisplayWithParams[pociatocnyTrojuholnik];
            ...
            "Skosenie", Module[{result, params},
                ...
                {params, result} = TrojuholnikSkosenieNoDisplayWithParams[pociatocnyTrojuholnik];
            ...
            "Symetria", Module[{result, axis},
                ...
                {axis, result} = TrojuholnikSymetriaNoDisplayWithParams[pociatocnyTrojuholnik];
        ...
        AppendTo[transformovane, druhyTrojuholnik];
        finalnyTrojuholnik = druhyTrojuholnik;
    ];
    ...
    If[numTransformations >= 2, 
        ...
        tretiTrojuholnik = Switch[druhaTransformacia,
            "Posun", Module[{result, dx, dy, translationParams}, 
                translationParams = GetTranslationParametersNoDisplay[EnsureExactValues[druhyTrojuholnik]];
            ...
            "Rot\[AAcute]cia", Module[{result, angle},
                If[rotaciaUhol2 != 0,
                    TrojuholnikHardBalik`Transforms`Rotacia`RotaciaUhol = rotaciaUhol2;
                ];
                {angle, result} = TrojuholnikRotaciaNoDisplayWithParams[EnsureExactValues[druhyTrojuholnik]];
                rotaciaUhol2 = angle;
                AppendTo[transformParams, rotaciaUhol2];
                result],
                
            "Zv\[ADoubleDot]\[CHacek]\[SHacek]enie/Zmen\[SHacek]enie", Module[{result, params},
                {params, result} = TrojuholnikZvacsenieZmensenieNoDisplayWithParams[EnsureExactValues[druhyTrojuholnik]];
                zvacsenieParams2 = params;
                AppendTo[transformParams, zvacsenieParams2];
                result],
                
            "Skosenie", Module[{result, params},
                {params, result} = TrojuholnikSkosenieNoDisplayWithParams[EnsureExactValues[druhyTrojuholnik]];
            ...
            "Symetria", Module[{result, axis},
                ...
                {axis, result} = TrojuholnikSymetriaNoDisplayWithParams[EnsureExactValues[druhyTrojuholnik]];
        ...
        AppendTo[transformovane, tretiTrojuholnik];
        finalnyTrojuholnik = tretiTrojuholnik;
    ];
    ...
    If[numTransformations >= 3, 
        ...
        finalnyTrojuholnik = Switch[tretiaTransformacia,
            "Posun", Module[{result, dx, dy, translationParams}, 
                translationParams = GetTranslationParametersNoDisplay[EnsureExactValues[tretiTrojuholnik]];
            ...
            "Rot\[AAcute]cia", Module[{result, angle},
                If[rotaciaUhol3 != 0,
                    TrojuholnikHardBalik`Transforms`Rotacia`RotaciaUhol = rotaciaUhol3;
                ];
                {angle, result} = TrojuholnikRotaciaNoDisplayWithParams[EnsureExactValues[tretiTrojuholnik]];
                rotaciaUhol3 = angle;
                AppendTo[transformParams, rotaciaUhol3];
                result],
                
            "Zv\[ADoubleDot]\[CHacek]\[SHacek]enie/Zmen\[SHacek]enie", Module[{result, params},
                {params, result} = TrojuholnikZvacsenieZmensenieNoDisplayWithParams[EnsureExactValues[tretiTrojuholnik]];
                zvacsenieParams3 = params;
                AppendTo[transformParams, zvacsenieParams3];
                result],
                
            "Skosenie", Module[{result, params},
                {params, result} = TrojuholnikSkosenieNoDisplayWithParams[EnsureExactValues[tretiTrojuholnik]];
            ...
            "Symetria", Module[{result, axis},
                ...
                {axis, result} = TrojuholnikSymetriaNoDisplayWithParams[EnsureExactValues[tretiTrojuholnik]];
        ...
        AppendTo[transformovane, finalnyTrojuholnik];
    ];
    
    
    Print[Style["GEOMETRICK\[CapitalAAcute] TRANSFORM\[CapitalAAcute]CIA TROJUHOLN\[CapitalIAcute]KA - " <> 
    ...
    If[numTransformations >= 1,
        ...
        druhyTrojuholnik = Switch[prvaTransformacia,
            "Posun", 
                Module[{}, 
                    TrojuholnikHardBalik`Transforms`Posun`TrojuholnikPosunVector = posunVektor1;
                    TrojuholnikPosun[pociatocnyTrojuholnik]
                ],
            "Rot\[AAcute]cia", 
                Module[{}, 
                    TrojuholnikHardBalik`Transforms`Rotacia`RotaciaUhol = rotaciaUhol1;
                    TrojuholnikRotacia[pociatocnyTrojuholnik]
                ],
            "Zv\[ADoubleDot]\[CHacek]\[SHacek]enie/Zmen\[SHacek]enie", 
                Module[{}, 
                    TrojuholnikHardBalik`Transforms`ZvacsenieZmensenie`ZvacsenieParams = zvacsenieParams1;
                    TrojuholnikZvacsenieZmensenie[pociatocnyTrojuholnik]
                ],
            "Skosenie", 
                Module[{}, 
                    TrojuholnikHardBalik`Transforms`Skosenie`SkosenieParams = skosenieParams1;
                    TrojuholnikSkosenie[pociatocnyTrojuholnik]
                ],
            "Symetria", 
                Module[{}, 
                    
                    TrojuholnikHardBalik`Transforms`Symetria`SymetriaOs = symetriaOs1;
                    TrojuholnikSymetria[pociatocnyTrojuholnik]
                ]
        ];
    ];
    ...
    If[numTransformations >= 2,
        ...
        tretiTrojuholnik = Switch[druhaTransformacia,
            "Posun", 
                Module[{}, 
                    TrojuholnikHardBalik`Transforms`Posun`TrojuholnikPosunVector = posunVektor2;
                    TrojuholnikPosun[EnsureExactValues[druhyTrojuholnik]]
                ],
            "Rot\[AAcute]cia", 
                Module[{}, 
                    TrojuholnikHardBalik`Transforms`Rotacia`RotaciaUhol = rotaciaUhol2;
                    TrojuholnikRotacia[EnsureExactValues[druhyTrojuholnik]]
                ],
            "Zv\[ADoubleDot]\[CHacek]\[SHacek]enie/Zmen\[SHacek]enie", 
                Module[{}, 
                    TrojuholnikHardBalik`Transforms`ZvacsenieZmensenie`ZvacsenieParams = zvacsenieParams2;
                    TrojuholnikZvacsenieZmensenie[EnsureExactValues[druhyTrojuholnik]]
                ],
            "Skosenie", 
                Module[{}, 
                    TrojuholnikHardBalik`Transforms`Skosenie`SkosenieParams = skosenieParams2;
                    TrojuholnikSkosenie[EnsureExactValues[druhyTrojuholnik]]
                ],
            "Symetria", 
                Module[{}, 
                    
                    TrojuholnikHardBalik`Transforms`Symetria`SymetriaOs = symetriaOs2;
                    TrojuholnikSymetria[EnsureExactValues[druhyTrojuholnik]]
                ]
        ];
    ];
    ...
    If[numTransformations >= 3,
        ...
        finalnyTrojuholnik = Switch[tretiaTransformacia,
            "Posun", 
                Module[{}, 
                    TrojuholnikHardBalik`Transforms`Posun`TrojuholnikPosunVector = posunVektor3;
                    TrojuholnikPosun[EnsureExactValues[tretiTrojuholnik]]
                ],
            "Rot\[AAcute]cia", 
                Module[{}, 
                    TrojuholnikHardBalik`Transforms`Rotacia`RotaciaUhol = rotaciaUhol3;
                    TrojuholnikRotacia[EnsureExactValues[tretiTrojuholnik]]
                ],
            "Zv\[ADoubleDot]\[CHacek]\[SHacek]enie/Zmen\[SHacek]enie", 
                Module[{}, 
                    TrojuholnikHardBalik`Transforms`ZvacsenieZmensenie`ZvacsenieParams = zvacsenieParams3;
                    TrojuholnikZvacsenieZmensenie[EnsureExactValues[tretiTrojuholnik]]
                ],
            "Skosenie", 
                Module[{}, 
                    TrojuholnikHardBalik`Transforms`Skosenie`SkosenieParams = skosenieParams3;
                    TrojuholnikSkosenie[EnsureExactValues[tretiTrojuholnik]]
                ],
            "Symetria", 
                Module[{}, 
                    
                    TrojuholnikHardBalik`Transforms`Symetria`SymetriaOs = symetriaOs3;
                    TrojuholnikSymetria[EnsureExactValues[tretiTrojuholnik]]
                ]
        ];
    ];
    ...
    DisplayTransformationSequence[
        pociatocnyTrojuholnik,
        druhyTrojuholnik,
        If[numTransformations >= 2, tretiTrojuholnik, druhyTrojuholnik],  
        finalnyTrojuholnik,
        prvaTransformacia,
    ...
    If[numTransformations >= 1,
        Print[Style["\[Bullet] Tmavozelen\[EAcute]", RGBColor[0, 0.8, 0.2], Bold], " body a \[CHacek]iary: Trojuholn\[IAcute]k po prvej transform\[AAcute]cii (", 
              Style[prvaTransformacia, Bold], ")"];
    ];
    
    If[numTransformations >= 2,
        Print[Style["\[Bullet] Oran\[ZHacek]ov\[EAcute]", RGBColor[1, 0.6, 0], Bold], " body a \[CHacek]iary: Trojuholn\[IAcute]k po druhej transform\[AAcute]cii (", 
              Style[druhaTransformacia, Bold], ")"];
    ];
    
    If[numTransformations >= 3,
        Print[Style["\[Bullet] \[CapitalCHacek]erven\[EAcute]", RGBColor[0.9, 0.1, 0.1], Bold], " body a \[CHacek]iary: Trojuholn\[IAcute]k po tretej transform\[AAcute]cii (", 
    ...
    {pociatocnyTrojuholnik, transformovane, transformacie, difficultyLevel, transformParams}
...
TrojuholnikRotaciaNoDisplay[vertices_] := 
    Module[{angle, result},
        angle = RandomChoice[{30, 45, 60, 90, 120, 135, 180, 270}];
