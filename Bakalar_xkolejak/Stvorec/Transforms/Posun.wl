...
BeginPackage["StvorecHardBalik`Transforms`Posun`", {"StvorecHardBalik`"}];

StvorecPosunVector::usage = "StvorecPosunVector je globalny vektor posunu [dx, dy], ktory sa pouziva v StvorecPosun funkcii.";

StvorecPosun::usage = 
    "StvorecPosun[vertices_] zobraz\[IAcute] interakt\[IAcute]vny tutori\[AAcute]l pre posun \[SHacek]tvorca a vr\[AAcute]ti nov\[EAcute] vrcholy.";

Begin["`Private`"];

StvorecPosunVector = {0, 0};
...
NormalizeVertices[vertices_] := 
    Module[{processedVertices},
                ...
                If[Length[DeleteDuplicates[Length /@ vertices]] > 1,
                    ...
                    Block[{cleanedVertices = Select[vertices, VectorQ]},
                        If[Length[cleanedVertices] >= 4,
                            cleanedVertices[[1;;4]],
                            Message[StvorecPosun::invalidInput]; 
                            Abort[]
                        ]
                    ],
        ...
        If[Length[processedVertices] < 4,
            Message[StvorecPosun::insufficientVertices];
            Abort[]
        ];
...
StvorecPosun[inputVertices_] := 
    Module[{normalizedVertices, outputVertices, dx, dy, invDx, invDy,
        ...
        If[StvorecPosunVector =!= {0, 0},
            
            {dx, dy} = StvorecPosunVector;
        ...
        Print[Style[
            "GEOMETRICK\[CapitalEAcute] TRANSFORM\[CapitalAAcute]CIE \[CapitalSHacek]TVORCA - POSUN", 
            Bold, 16]];
        Print[Style["========================================", Bold]];
        ...
        Print["\nVykonajte posun \[SHacek]tvorca v 2D priestore pomocou vektora posunu: \[CapitalDelta] = [", 
        ...
        Print[Style["Posunut\[YAcute] \[SHacek]tvorec A'B'C'D':", Red, Bold]];
        ...
        Print[Style["\[Bullet] \[CapitalCHacek]erven\[EAcute]", Red], " body a \[CHacek]iary: Posunut\[YAcute] \[SHacek]tvorec"];
        ...
        Print["\[Bullet] Posun zachov\[\[AAcute]]va obsah a obvod \[SHacek]tvorca"];
...
StvorecPosun::invalidInput = "Neplatn\[YAcute] vstup. O\[CHacek]ak\[\[AAcute]]va sa matica alebo zoznam s\[\[UAcute]]radn\[IAcute]c \[SHacek]tvorca.";
StvorecPosun::insufficientVertices = "Nedostato\[CHacek]n\[YAcute] po\[CHacek]et vrcholov. S\[\[UAcute]] potrebn\[EAcute] presne 4 vrcholy.";
