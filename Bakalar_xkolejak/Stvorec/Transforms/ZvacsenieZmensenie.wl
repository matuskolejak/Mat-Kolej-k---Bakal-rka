...
ZvacsenieParams::usage = "ZvacsenieParams je globalny vektor {sx, sy} pre koeficienty zvacsenia/zmensenia, ktory sa pouziva v StvorecZvacsenieZmensenie funkcii.";

GenerateScalingParameters::usage = "GenerateScalingParameters[] generuje nahodne parametre pre zvacsenie/zmensenie.";
    ...
    Module[{sx, sy, typTransformacie, popis, spolPodst, finalVertices, 
        ...
        If[detectedScaling =!= None,
            ...
            {typTransformacie, popis, spolPodst} = 
                StvorecHardBalik`Transforms`ZvacsenieZmensenie`IdentifyTransformationType[sx, sy];
            ...
            If[StvorecHardBalik`Transforms`ZvacsenieZmensenie`ZvacsenieParams =!= {0, 0},
                ...
                {sx, sy, typTransformacie, popis, spolPodst} = 
                    StvorecHardBalik`Transforms`ZvacsenieZmensenie`GenerateScalingParameters[]
            ];
...
StvorecZvacsenieZmensenie[inputVertices_] := 
    Module[{sx, sy, typTransformacie, popis, spolPodst, finalVertices, 
        ...
        Print[Style["\nVykonajte " <> ToString[spolPodst] <> " \[SHacek]tvorca pomocou transforma\[CHacek]nej matice v 2D priestore:", Bold]];
        Print[MatrixForm[{
        ...
        Print[Style["Transformovan\[YAcute] \[SHacek]tvorec A'B'C'D':", Red, Bold]];
        ...
        Print[Style["\[Bullet] \[CapitalCHacek]erven\[EAcute]", Red], " body a \[CHacek]iary: Transformovan\[YAcute] \[SHacek]tvorec"];
        ...
        If[sx == sy,
            ...
            Print["  - Zachov\[AAcute]vaj\[UAcute] sa v\[SHacek]etky uhly medzi \[UAcute]se\[CHacek]kami (90\[Degree] \[SHacek]tvorca sa zachov\[AAcute]vaj\[UAcute])"];
            Print["  - Pomer d\:013a\[ZHacek]ok \[UAcute]se\[CHacek]iek sa zachov\[AAcute]va"];
            Print["  - Obsah \[SHacek]tvorca sa " <> If[sx > 1, "zv\[ADoubleDot]\[CHacek]\[SHacek]\[IAcute] " <> FormatExactValue[sx^2] <> "-kr\[AAcute]t", "zmen\[SHacek]\[IAcute] na " <> FormatExactValue[1/sx^2] <> ". \[CHacek]as\[THacek]"]],
            
            Print["  - Men\[IAcute] sa tvar geometrick\[YAcute]ch \[UAcute]tvarov - \[SHacek]tvorec sa meni na obd\:013a\[ZHacek]nik"];
            Print["  - Uhly medzi \[UAcute]se\[CHacek]kami sa zachov\[AAcute]vaj\[UAcute] (90\[Degree] \[SHacek]tvorca zostan\[UAcute] 90\[Degree])"];
            Print["  - Pomer d\:013a\[ZHacek]ok \[UAcute]se\[CHacek]iek sa men\[IAcute] v z\[AAcute]vislosti od ich smeru"];
            Print["  - Obsah \[SHacek]tvorca sa " <> If[sx*sy > 1, "zv\[ADoubleDot]\[CHacek]\[SHacek]\[IAcute] " <> FormatExactValue[sx*sy] <> "-kr\[AAcute]t", "zmen\[SHacek]\[IAcute] na " <> FormatExactValue[1/(sx*sy)] <> ". \[CHacek]as\[THacek]"]]
        ];
