...
RotaciaUhol::usage = "RotaciaUhol je glob\[AAcute]lna premenn\[AAcute], ktor\[AAcute] sa pou\[ZHacek]\[IAcute]va na ulo\[ZHacek]enie uhla rot\[AAcute]cie v stup\[NHacek]och.";
...
StvorecRotacia[inputVertices_] := 
    Module[{normalizedVertices, angle, popis, outputVertices, cosA, sinA, invAngle, cosInvA, sinInvA,
        ...
        normalizedVertices = If[Length[inputVertices] >= 4, 
                                inputVertices[[1;;4]], 
                                Message[StvorecRotacia::insufficientVertices]; Abort[]];
        ...
        Print["Pri rot\[AAcute]cii v 2D priestore pou\[ZHacek]\[IAcute]vame homog\[EAcute]nne s\[UAcute]radnice, ktor\[EAcute] umo\[ZHacek]\[NHacek]uj\[UAcute] vyjadri\[THacek] rot\[AAcute]ciu ako maticov\[EAcute] n\[AAcute]sobenie:"];
        ...
        Print[Style["\nV\[CapitalYAcute]PO\[CapitalCHacek]ET ROT\[CapitalAAcute]CIE JEDNOTLIV\[CapitalYAcute]CH VRCHOLOV:", Bold, 14]];
        ...
        Table[
            Module[{x = normalizedVertices[[i, 1]], 
                ...
                Print[Style["\nAlternat\[IAcute]vny v\[YAcute]po\[CHacek]et pomocou z\[AAcute]kladn\[YAcute]ch vzorcov rot\[AAcute]cie:", Bold]];
        ...
        Print[Style["Rotovan\[YAcute] \[SHacek]tvorec A'B'C'D':", Red, Bold]];
        ...
        Print[Style["\[Bullet] \[CapitalCHacek]erven\[EAcute]", Red], " body a \[CHacek]iary: Rotovan\[YAcute] \[SHacek]tvorec"];
        Print[Style["\[Bullet] Zelen\[EAcute]", darkGreen], " preru\[SHacek]ovan\[EAcute] \[CHacek]iary: Spojnice bodov s po\[CHacek]iatkom"];
        Print[Style["\[Bullet] O: Po\[CHacek]iatok s\[UAcute]radnicovej s\[UAcute]stavy - stred rot\[AAcute]cie", Black]];
