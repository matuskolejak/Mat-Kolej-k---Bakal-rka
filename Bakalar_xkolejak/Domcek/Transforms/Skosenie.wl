...
SkosenieParams::usage = "SkosenieParams je globalny parameter skosenia {kx, ky}, ktory sa pouziva v DomcekSkosenie funkcii.";


DomcekSkosenieNoDisplayWithParams::usage = 
    "DomcekSkosenieNoDisplayWithParams[vertices_] vrati parametry skosenia a nove vrcholy bez zobrazovania.";
...
DomcekSkosenie[inputVertices_] := 
    Module[{normalizedVertices, shearParams, outputVertices, kx, ky, smer, popis, 
        ...
        normalizedVertices = If[MatrixQ[inputVertices] && Length[inputVertices] == 5 && 
        ...
        If[Length[inputVertices] > 5 && Mod[Length[inputVertices], 5] == 0,
            ...
            finalVertices = inputVertices[[-(5;;-1)]];
        ...
        If[smer == "v smere os\[IAcute] x a y",
            Print["\nVykonajte skosenie dom\[CHacek]eka v 2D priestore v smere osi x s koeficientom k = ", 
        ...
        Print[Style["Skosen\[YAcute] dom\[CHacek]ek A'B'C'D'E':", Red, Bold]];
        ...
        Print[Style["\[Bullet] \[CapitalCHacek]erven\[EAcute]", Red], " body a \[CHacek]iary: Skosen\[YAcute] dom\[CHacek]ek"];
...
DomcekSkosenie::insufficientVertices = "Nedostato\[CHacek]n\[YAcute] po\[CHacek]et vrcholov. S\[UAcute] potrebn\[EAcute] aspo\[NHacek] 5 vrcholov.";
