...
DisplayTransformationSequence[pociatocny_, druhy_, treti_, finalny_, prva_, druha_, tretia_] := Module[{},
    ...
    Print["Vrcholy dom\[CHacek]eka po tretej transform\[AAcute]cii:"];
...
CreateDomcekVisualization[pociatocny_, druhy_, treti_, finalny_, prva_, druha_, tretia_] := 
    Module[{
        ...
        labels3 = {"A''", "B''", "C''", "D''", "E''"},
        labels4 = {"A'''", "B'''", "C'''", "D'''", "E'''"},
        originalHouseLines, secondHouseLines, thirdHouseLines, finalHouseLines
    },
        ...
        (* Define house lines for all four houses *)
        ...
        *)
		...
		(* Third house (orange) *)
		thirdHouseLines = {
		    {treti[[1]], treti[[2]]},  (* A''-B'': bottom line *)
		    {treti[[2]], treti[[3]]},  (* B''-C'': right side *)
		    {treti[[3]], treti[[4]]},  (* C''-D'': top line *)
		    {treti[[4]], treti[[1]]},  (* D''-A'': left side *)
		    {treti[[3]], treti[[5]]},  (* C''-E'': right roof *)
		    {treti[[4]], treti[[5]]}   (* D''-E'': left roof *)
		};
        ...
        labelPositions = Table[
            ...
            {i, 20}  (* 5 vertices per domcek, 4 domceky *)
        ];
        ...
        Graphics[{
            ...
            (* Third domcek - orange - proper house shape *)
            {brightOrange, Thickness[0.005], Opacity[0.9], 
                Line /@ thirdHouseLines
            },
            
            (* Final domcek - red - proper house shape *)
            {brightRed, Thickness[0.005], Opacity[0.9], 
                Line /@ finalHouseLines
            },
            
            (* Vertex points - original domcek - removed black circles *)
            Table[
                {
            ...
            (* Vertex points - second domcek - removed black circles *)
            Table[
                {
            ...
            (* Vertex points - third domcek - removed black circles *)
            Table[
                {
                    White, Disk[treti[[i]], 0.20],
                    brightOrange, Disk[treti[[i]], 0.15]
                    (* Removed black circles *)
                },
                {i, 5}
            ],
            
            (* Vertex points - final domcek - removed black circles *)
            Table[
                {
                    White, Disk[finalny[[i]], 0.20],
                    brightRed, Disk[finalny[[i]], 0.15]
                    (* Removed black circles *)
                },
                {i, 5}
            ],
            ...
            Table[
                With[{
                    label = Which[
                        ...
                        i <= 15, labels3[[i - 10]],      (* Third domcek - A'' to E'' *)
                        True, labels4[[i - 15]]          (* Final domcek - A''' to E''' *)
                    ],
                    color = Which[
                        i <= 5, brightBlue,
                        i <= 10, brightGreen,
        ...
        ImageSize -> 650,
        PlotLabel -> Style["Postupn\[AAcute] aplik\[AAcute]cia troch transform\[AAcute]ci\[IAcute] dom\[CHacek]eka", Bold, 16],
...
DomcekTrojitaTransformacia[] := Module[{
    ...
    Print[Style["TROJIT\[CapitalAAcute] GEOMETRICK\[CapitalAAcute] TRANSFORM\[CapitalAAcute]CIA DOM\[CapitalCHacek]EKA", Bold, 24]];
    Print[Style["==========================================", Bold]];
    ...
    finalnyDomcek = Switch[tretiaTransformacia,
        "Posun", DomcekPosun[tretiDomcek],
        "Rot\[AAcute]cia", DomcekRotacia[tretiDomcek],
        "Zv\[ADoubleDot]\[CHacek]\[SHacek]enie/Zmen\[SHacek]enie", DomcekZvacsenieZmensenie[tretiDomcek],
        "Skosenie", DomcekSkosenie[tretiDomcek],
        "Symetria", DomcekSymetria[tretiDomcek]
    ];
    ...
    {pociatocnyDomcek, druhyDomcek, tretiDomcek, finalnyDomcek, 
...
EndPackage[]; (* Uzavretie DomcekHardBalik package *)
