...
BeginPackage["DomcekHardBalik`Transforms`Skosenie`", {"DomcekHardBalik`"}];

(* Export public symbols *)
DomcekSkosenie::usage = 
    "DomcekSkosenie[vertices_] zobraz\[IAcute] interakt\[IAcute]vny tutori\[AAcute]l pre skosenie dom\[CHacek]eka a vr\[AAcute]ti nov\[EAcute] vrcholy.";
...
NormalizeVertices[vertices_] := 
    Module[{processedVertices},
                ...
                If[Length[DeleteDuplicates[Length /@ vertices]] > 1,
                    ...
                    Block[{cleanedVertices = Select[vertices, VectorQ]},
                        If[Length[cleanedVertices] >= 5,
                            cleanedVertices[[1;;5]],
                            Message[DomcekSkosenie::invalidInput]; 
                            Abort[]
                        ]
                    ],
        ...
        If[Length[processedVertices] < 5,
            Message[DomcekSkosenie::insufficientVertices];
            Abort[]
        ];
...
CreateVisualization[originalVertices_, finalVertices_, k_, smer_] := 
    Module[{allVertices, xMin, xMax, yMin, yMax, rangeBuffer, xRange, yRange, 
            labelOffsets, kx, ky, brightGreen, originalHouseLines, finalHouseLines},
        ...
        Graphics[{
            ...
            (* Skosen\[YAcute] dom\[CHacek]ek - \[CHacek]erven\[YAcute] *)
...
DomcekSkosenie[inputVertices_] := 
    Module[{normalizedVertices, shearParams, outputVertices, kx, ky, smer, popis, 
        ...
        (* Get shearing parameters - we won't detect previous transformations now *)
        ...
        (* Set coefficient for display in process *)
        ...
        (* Coefficients for transformation matrix *)
        koefX = If[smer == "v smere osi x", k, 0];
        koefY = If[smer == "v smere osi y", k, 0];
        
        (* Title *)
        Print[Style[
            "GEOMETRICK\[CapitalEAcute] TRANSFORM\[CapitalAAcute]CIE DOM\[CapitalCHacek]EKA - SKOSENIE", 
            Bold, 16]];
        Print[Style["========================================", Bold]];
        ...
        Print["\nVykonajte skosenie dom\[CHacek]eka v 2D priestore " <> smer <> " s koeficientom k = ", 
        ...
        Table[
            Module[{x = normalizedVertices[[i, 1]], 
                ...
                Print[Style["V\[YAcute]sledn\[EAcute] s\[UAcute]radnice:", Bold], " [", 
                      FormatExactValue[expandedX], ", ", FormatExactValue[expandedY], "]"];
                ...
                If[smer == "v smere osi x",
                    ...
                    (* Rozvinieme v\[YAcute]po\[CHacek]et pre lep\[SHacek]iu \[CHacek]itate\:013enos\[THacek] *)
                    If[outputVertices[[i, 2]] != 0 && k != 0,
                        Print["x = ", FormatExactValue[outputVertices[[i, 1]]], " + (", 
                              FormatExactValue[-k*outputVertices[[i, 2]]], ")"]
                    ];
                    
                    Print["x = ", FormatExactValue[Expand[outputVertices[[i, 1]] - k*outputVertices[[i, 2]]]], 
                          " = ", FormatExactValue[x]];
                    ...
                    Print["y = ", FormatExactValue[Expand[-k*outputVertices[[i, 1]] + outputVertices[[i, 2]]]], 
                          " = ", FormatExactValue[y]]
                ];
                ...
                If[smer == "v smere osi x",
                    Print[
                        Row[{
                            ...
                            MatrixForm[{{x}, {y}}],
                            " = ",
                            MatrixForm[{{Style[expandedX, Red]}, {Style[expandedY, Red]}}]
                        }]
                    ],
                    Print[
                        Row[{
        ...
        (* RESULT section - fully expanded values *)
        Print[Style["\nV\[CapitalYAcute]SLEDOK:", Bold, 14]];
        Print["Vrcholy dom\[CHacek]eka po skosen\[IAcute]:"];
        
        (* This section fully expands the output vertices to remove parentheses *)
        Module[{expandedVertices, formattedMatrix},
            ...
            (* Format the matrix for display with expanded values *)
        ...
        Print["\[Bullet] \[CapitalCHacek]erven\[EAcute] body a \[CHacek]iary: Skosen\[YAcute] dom\[CHacek]ek"];
        ...
        Table[
            Module[{expandedX, expandedY},
                (* Fully expand the values for display *)
        ...
        Print["\[Bullet] Pre k = 1 sa vytvor\[IAcute] dom\[CHacek]ek s naklonenou stranou alebo strechou (pod\:013ea smeru skosenia)"];
        Print["\[Bullet] Pre k = -1 sa vytvor\[IAcute] dom\[CHacek]ek s naklonenou stranou alebo strechou v opa\[CHacek]nom smere"];
...
DomcekSkosenie::invalidInput = "Neplatn\[YAcute] vstup. O\[CHacek]ak\[AAcute]va sa matica alebo zoznam s\[UAcute]radn\[IAcute]c dom\[CHacek]eka.";
DomcekSkosenie::insufficientVertices = "Nedostato\[CHacek]n\[YAcute] po\[CHacek]et vrcholov. S\[UAcute] potrebn\[EAcute] aspo\[NHacek] 5 vrcholy.";
