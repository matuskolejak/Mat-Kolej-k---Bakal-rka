    ...
    Module[{dx, dy, valid = False, newVertices, 
        ...
        While[!valid,
            ...
            valid = 
                ...
                (* Zabr\[AAcute]nenie prieniku trojuholn\[IAcute]kov *)
                Min[
                    Table[
...
CreateVisualization[originalVertices_, finalVertices_, translationVector_] := 
    Module[{allVertices, xMin, xMax, yMin, yMax, rangeBuffer, xRange, yRange, 
        ...
        Graphics[{
            ...
            (* Posunut\[YAcute] trojuholn\[IAcute]k - \[CHacek]erven\[YAcute] *)
...
TrojuholnikPosun[inputVertices_] := 
    Module[{normalizedVertices, translationParams, outputVertices, dx, dy, invDx, invDy},
        ...
        If[Length[inputVertices] === 3 && validTriangleQ @@ inputVertices,
        ...
        Print["Vrcholy trojuholn\[IAcute]ka po posune:"];
        ...
        Print["\[Bullet] \[CapitalCHacek]erven\[EAcute] body a \[CHacek]iary: Posunut\[YAcute] trojuholn\[IAcute]k"];
