...
GenerateScalingParameters[] := 
    Module[{sx, sy, citatel, menovatel, typTransformacie, popis, valid = False, narocnost},
        ...
        While[!valid,
            ...
            (* Kontroly validity *)
            valid = 
                (* Kontrola, \[CHacek]i koeficienty nie s\[UAcute] pr\[IAcute]li\[SHacek] mal\[EAcute] alebo ve\:013ek\[EAcute] *)
                1/4 <= sx <= 4 && 1/4 <= sy <= 4 &&
...
(* Hlavn\[AAcute] funkcia pre zv\[ADoubleDot]\[CHacek]\[SHacek]enie/zmen\[SHacek]enie trojuholn\[IAcute]ka *)
TrojuholnikZvacsenieZmensenie[inputVertices_] := 
    Module[{sx, sy, typTransformacie, popis, spolPodst, finalVertices, 
        ...
        Print["\nVykonajte " <> spolPodst <> " trojuholn\[IAcute]ka pomocou transforma\[CHacek]nej matice v 2D priestore:"];
        Print[MatrixForm[{
        ...
        Print["Vrcholy trojuholn\[IAcute]ka po " <> spolPodst <> ":"];
        ...
        Print["\[Bullet] \[CapitalCHacek]erven\[EAcute] body a \[CHacek]iary: Trojuholn\[IAcute]k po " <> spolPodst];
...
CreateVisualization[originalVertices_, finalVertices_, sx_, sy_, typTransformacie_] := 
    Module[{allVertices, xMin, xMax, yMin, yMax, rangeBuffer, xRange, yRange, 
        ...
        Graphics[{
            ...
            (* Zv\[ADoubleDot]\[CHacek]\[SHacek]en\[YAcute]/zmen\[SHacek]en\[YAcute] trojuholn\[IAcute]k - \[CHacek]erven\[YAcute] *)
