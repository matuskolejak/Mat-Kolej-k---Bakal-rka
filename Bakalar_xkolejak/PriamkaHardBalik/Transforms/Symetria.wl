...
BeginPackage["PriamkaHardBalik`Transforms`Symetria`", {"PriamkaHardBalik`"}];

(* Export public symbols *)
PriamkaSymetria::usage = 
    "PriamkaSymetria[vertices_] zobraz\[IAcute] interakt\[IAcute]vny tutori\[AAcute]l pre symetriu priamky pod\:013ea priamky a vr\[AAcute]ti nov\[EAcute] vrcholy.";
...
NormalizeVertices[vertices_] := 
    Module[{normalizedVertices, processedVertices},
                ...
                If[Length[DeleteDuplicates[Length /@ vertices]] > 1,
                    ...
                    Block[{cleanedVertices = Select[vertices, VectorQ]},
                        If[Length[cleanedVertices] >= 2,
                            cleanedVertices[[1;;2]],
                            Message[PriamkaSymetria::invalidInput]; 
                            Abort[]
                        ]
                    ],
        ...
        If[Length[normalizedVertices] < 2,
            Message[PriamkaSymetria::insufficientVertices];
            Abort[]
        ];
...
ReflectPointOverLine[point_, a_, b_, c_] := 
    Module[{x, y, d, xNew, yNew, factor},
        ...
        (* Vzdialenos\[THacek] bodu od priamky - pou\[ZHacek]\[IAcute]vame presn\[EAcute] v\[YAcute]razy *)
...
GenerateSymmetryLine[vertices_] := 
    Module[{a, b, c, validLine = False, allVertices, 
        ...
        (* 1. Najprv vytvor\[IAcute]m n\[AAcute]hodn\[YAcute] cie\:013eov\[YAcute] \[UAcute]tvar *)
        (* 2. Potom n\[AAcute]jdem symetriu, ktor\[AAcute] prevedie p\[OHat]vodn\[YAcute] na cie\:013eov\[YAcute] *)
        (* 3. Nakoniec over\[IAcute]m, \[ZHacek]e inverzn\[AAcute] transform\[AAcute]cia vr\[AAcute]ti spr\[AAcute]vne p\[OHat]vodn\[YAcute] \[UAcute]tvar *)
        ...
        While[!validLine && attempts < maxAttempts,
            ...
            *)
            ...
            (* Kontrola minim\[AAcute]lnej zmeny - \[UAcute]tvary s\[UAcute] dostato\[CHacek]ne odli\[SHacek]n\[EAcute] *)
            If[validLine, 
            ...
            If[validLine,
                ...
                (* 4. Overenie, \[ZHacek]e inverzn\[AAcute] transform\[AAcute]cia vr\[AAcute]ti p\[OHat]vodn\[YAcute] \[UAcute]tvar *)
...
CreateVisualization[originalVertices_, finalVertices_, a_, b_, c_, lineType_, xIntercept_, yIntercept_] := 
    Module[{allVertices, xMin, xMax, yMin, yMax, rangeBuffer, xRange, yRange, 
        ...
        Graphics[{
            ...
            (* Symetrick\[AAcute] priamka - \[CHacek]erven\[AAcute] *)
...
FormatLineEquation[a_, b_, c_] := 
    Module[{eqn = ""},
        (* Vytvor\[IAcute]\[THacek] rovnicu priamky vo forme ax + by + c = 0 *)
        If[a == 0 && b == 0,
...
PriamkaSymetria[inputVertices_] := 
    Module[{normalizedVertices, symmetryParams, outputVertices, 
        ...
        (* V\[YAcute]po\[CHacek]et vzdialenost\[IAcute] medzi p\[OHat]vodn\[YAcute]mi bodmi a priesekmi *)
        distances = MapThread[
        ...
        (* Nadpis *)
        Print[Style[
            "GEOMETRICK\[CapitalEAcute] TRANSFORM\[CapitalAAcute]CIE PRIAMKY - SYMETRIA", 
            Bold, 16]];
        Print[Style["========================================", Bold]];
        ...
        Print["Body priamky po symetrii:"];
        ...
        Print["\[Bullet] \[CapitalCHacek]erven\[EAcute] body a \[CHacek]iary: Priamka po symetrii"];
        Print["\[Bullet] Zelen\[AAcute] priamka: Os symetrie"];
        Print["\[Bullet] Zelen\[EAcute] preru\[SHacek]ovan\[EAcute] \[CHacek]iary: Spojenia zodpovedaj\[UAcute]cich si bodov"];
        ...
        Print["\[Bullet] Symetria zachov\[AAcute]va uhly medzi priamkami a ich d\:013a\[ZHacek]ky"];
...
PriamkaSymetria::invalidInput = "Neplatn\[YAcute] vstup. O\[CHacek]ak\[AAcute]va sa matica alebo zoznam s\[UAcute]radn\[IAcute]c priamky.";
PriamkaSymetria::insufficientVertices = "Nedostato\[CHacek]n\[YAcute] po\[CHacek]et vrcholov. S\[UAcute] potrebn\[EAcute] aspo\[NHacek] 2 vrcholy.";
